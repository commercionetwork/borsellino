      ...
      child: Form(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              FormItem(fieldDescription: 'Recipient', fieldLabel: 'Recipient Address', keyboardType: TextInputType.text),
              FormItem(fieldDescription: 'Amount', fieldLabel: 'Coins amount' , keyboardType:  TextInputType.number),
